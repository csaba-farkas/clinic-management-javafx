...
package com.clinigment.application.view.metro.animations;
...
public class FadeInTransitionConfig extends Transition {
     ...
     */
    public FadeInTransitionConfig(final Node node, final Timeline timeline) {
     ...
     */
    public FadeInTransitionConfig(final Node node, final Timeline timeline, final boolean useCache) {
        this.node = node;
